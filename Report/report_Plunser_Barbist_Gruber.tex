...
\begin{itemize}
      ...
      \item \textbf{Tracking:} We implement multi-camera person tracking using torchreid for real-time person tracking and a custom
            cross-camera tracking system. This allows us to maintain person identity across multiple camera views and avoid redundant face recognition requests. 
